...
import {RemoveNewsComponent} from "./admin-news/remove-news/remove-news.component";
import {RemoveFantourComponent} from "./admin-fantours/remove-fantour/remove-fantour.component";
